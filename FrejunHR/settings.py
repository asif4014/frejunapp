"""
Django settings for FrejunHR project.
...
SECRET_KEY = 'vt)^!4dob))-przr6q_5kpokd&w#0(utc#93(t9*isk4yo+$@-'
...
WSGI_APPLICATION = 'FrejunHR.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'FrejunApp/static/FrejunApp/csvfiles')
